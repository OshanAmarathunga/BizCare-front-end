  ...
  return (
    <div className="bg-white mx-10 rounded-2xl mt-3 md:flex  justify-between">
      <div className="flex flex-col justify-center text-center bg-yellow-300 rounded-3xl w-full">
        <h1 className="text-[30px] md:text-[50px] font-bold p-3 font-poppins">Ultimate Business Solution Provider !</h1>
        <h1 className="text-[15px] md:text-[20px] font-light p-2 font-poppins">
        ...
        <div>
        <button className="bg-black text-white px-5 py-2 mb-3 rounded-2xl shadow-2xl font-poppins" >Contact US....</button>
        </div>
      </div>
