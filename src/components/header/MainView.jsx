  ...
  return (
    <div className="bg-white mx-10 rounded-2xl mt-3 md:flex  justify-between">
      <div className="flex flex-col justify-center text-center bg-yellow-300 rounded-3xl w-full">
        <h1 className="text-[30px] md:text-[50px] font-bold p-3">Your Finance Solution Provider !</h1>
        ...
        <div>
        <button className="bg-black text-white px-5 rounded-2xl shadow-2xl" >Contact US -></button>
        </div>
      </div>
