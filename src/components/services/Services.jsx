          ...
          <ul className="list-disc text-white pl-5 md:flex sm:flex-row">
            <div className="flex-col justify-between">
              <li className="mb-4 mx-4">
                <div className="font-semibold text-white hover:text-yellow-500">
              ...
              <li className="mb-4 mx-4">
                <div className=" text-white font-semibold hover:text-yellow-500">
      ...
      <div className="bg-blue-950 pt-1 px-5 mx-10 rounded-2xl mb-2">
        ...
        <ul className="list-disc text-white  pl-5 md:flex sm:flex-row">
          <div className="flex-col justify-between">
            ...
            <li className="mb-4 mx-4">
              <div className="font-semibold text-white  hover:text-yellow-500">Tapioca</div>
            </li>
            <li className="mb-4 mx-4">
              <div className="font-semibold text-white  hover:text-yellow-500">Papaya</div>
            </li>
          </div>
        </ul>
      </div>
